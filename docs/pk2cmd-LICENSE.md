# pk2cmd: license and provenance

`pk2cmd` is not `platform-epic8`'s code and is not MIT-licensed. This file
exists because clause 1(b) of Microchip's own license, reproduced in full
below, requires this exact notice to be "prominently posted in a location
where end users will see it," and because a clear accounting of what this
component is and isn't matters more than a link.

## What this actually is

`pk2cmd` drives PICkit2, PICkit3, "PICkit3.5" and PKOB programmer clones
over USB. The original tool was written by Microchip; the copy this
project points to is [`jaka-fi/pk2cmd`](https://github.com/jaka-fi/pk2cmd),
an actively maintained fork adding PICkit3/PKOB support and hundreds of
devices, itself building on earlier community contributions (see that
repository's own `README.md` "Thanks" section for the full chain). We do
not modify it. We fetch a specific, checksum-pinned release and run it as
an external process, the same posture this project already takes with
`gpasm` (GPL, external oracle, own license, never vendored into MIT code).

## Why we think distributing it is within the license

Section 1(a) below grants the right to "market, sell or otherwise
distribute... Your end application that integrates Software and Company
products." `platform-epic8`'s upload tooling is exactly that: an end
application that integrates `pk2cmd` (the Software) with genuine
Microchip PIC silicon (a Company product). This is our own reading, not
legal advice, and one real ambiguity is unresolved: whether "Company
products" is scoped to the target chip (satisfied here) or also
contemplates genuine Microchip-brand programmer hardware specifically
(not satisfied, since the point of this integration is clone hardware).
We are not aware of Microchip having pursued this distinction against
any of the many existing public `pk2cmd`-based projects that already
support clones, including this one.

## What this license does not cover

Independent invention is a defense to copyright claims; it is not a
defense to patent claims, and section 7 below is explicit that Microchip
"assume[s] no responsibility for, nor indemnify You against, any patent,
copyright or other intellectual property claims." We have not run a
patent search and are not aware of one reading on this tool.

## The license, verbatim

Fetched directly from `jaka-fi/pk2cmd`'s repository, unmodified.
...
This License Agreement (Agreement) is a contract between You (as an individual or as a representative of your employer) and Microchip Technology Incorporated ("Company") for the PICkit(tm) 2 PK2CMD software (including source code) accompanying this Agreement (the "Software").  In consideration for access to the Software, You agree to be bound by this Agreement.
...
11.  CHOICE OF LAW; VENUE; LIMITATIONS ON CLAIMS. You agree that this Agreement and any conflicts regarding Software, shall be construed, interpreted and governed by the laws, and subject to the exclusive jurisdiction of the state or territory in the Company Terms and Conditions of Sale ("T&Cs").  In the event that the T&Cs do not apply or the choice of law or jurisdiction are not indicated therein, then this Agreement shall be construed, interpreted and governed by the laws, and subject to the exclusive jurisdiction of the State of Arizona, U.S.A. without regard to any conflict of laws principles. You agree that regardless of any law to the contrary, any cause of action related to or arising out of this Agreement or Software must be filed within one year after such cause of action arose, or be considered waived.

12.  EXPORT COMPLIANCE. You will not export or re-export Software, technical data, direct products thereof or any other items which would violate any applicable export control laws and regulations including, but not limited to, those of the United States and the United Kingdom.  You agree that it is Your responsibility to obtain copies of and to familiarize yourself fully with these laws and regulations to avoid violation.

13.  ASSIGNMENT. Neither this agreement nor any rights, licenses or obligations hereunder, may be assigned by You without the Company's prior written approval.
