 ...
 * The LED is driven by writing the PORTB/TRISB SFRs directly.
 *
...
/* SFR addresses (DS41291H Tables 4-2..4-10): TRISB is the Bank-1
 * direction register, PORTB the Bank-0 port. */
