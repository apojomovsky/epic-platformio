...
# Honor build_flags from platformio.ini; the parsed defines are forwarded
# to epic-cc as -D below.
...
# directly, there is no per-object step to land in the build dir.
sources = [
