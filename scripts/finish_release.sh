...
for attempt in 1 2 3 4 5; do
  ...
  # that has already been built, smoke-tested and published.
  # rollup_changelog.py falls back to a placeholder line when neither
  # source is available.
  fallback_args=()
  ...
  echo "push rejected (attempt ${attempt}/5), resetting to origin/master and recomputing"
